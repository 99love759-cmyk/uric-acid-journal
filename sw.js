const CACHE = 'uric-acid-v8';
const ASSETS = ['./', './index.html', './styles.css?v=8', './overrides.css?v=8', './app.js?v=8', './manifest.webmanifest?v=8', './icon.svg?v=8', './icon-180.png?v=8', './icon-192.png?v=8', './icon-512.png?v=8'];
