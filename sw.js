const CACHE = 'uric-acid-v17';
const ASSETS = ['./', './index.html', './styles.css?v=17', './overrides.css?v=17', './app.js?v=17', './manifest.webmanifest?v=17', './icon.svg?v=17', './icon-180.png?v=17', './icon-192.png?v=17', './icon-512.png?v=17'];
