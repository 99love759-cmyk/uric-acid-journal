const CACHE = 'uric-acid-v21';
const ASSETS = ['./', './index.html', './styles.css?v=21', './overrides.css?v=21', './app.js?v=21', './manifest.webmanifest?v=21', './icon.svg?v=21', './icon-180.png?v=21', './icon-192.png?v=21', './icon-512.png?v=21'];
