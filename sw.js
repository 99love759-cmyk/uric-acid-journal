const CACHE = 'uric-acid-v18';
const ASSETS = ['./', './index.html', './styles.css?v=18', './overrides.css?v=18', './app.js?v=18', './manifest.webmanifest?v=18', './icon.svg?v=18', './icon-180.png?v=18', './icon-192.png?v=18', './icon-512.png?v=18'];
