const CACHE = 'uric-acid-v9';
const ASSETS = ['./', './index.html', './styles.css?v=9', './overrides.css?v=9', './app.js?v=9', './manifest.webmanifest?v=9', './icon.svg?v=9', './icon-180.png?v=9', './icon-192.png?v=9', './icon-512.png?v=9'];
