const CACHE = 'uric-acid-v16';
const ASSETS = ['./', './index.html', './styles.css?v=16', './overrides.css?v=16', './app.js?v=16', './manifest.webmanifest?v=16', './icon.svg?v=16', './icon-180.png?v=16', './icon-192.png?v=16', './icon-512.png?v=16'];
